        ...
        try {
            if (!inputs.newPassword.match(passwordRegex)) {
                return toast({
                    ...
                    description: "Must Contain at least 6 Characters, One Uppercase, One Lowercase, One Number and One Special Case Character",
                    position: "top",
                    status: "error",
                    duration: 3000,
                    isClosable: true
            ...
            await _src_config_api__WEBPACK_IMPORTED_MODULE_5__["default"].post(`users/resetPassword/${props.token}`, inputs);
            toast({
                title: "Success!",
...
var __webpack_exports__ = __webpack_require__.X(0, [377,675], () => (__webpack_exec__(8229)));
