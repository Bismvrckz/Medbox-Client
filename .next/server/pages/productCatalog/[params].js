...
async function getServerSideProps(context) {
    try {
        ...
        if (context.params.params.includes("semuaObat")) {
            ...
            resGetProducts = await _src_config_api__WEBPACK_IMPORTED_MODULE_4__["default"].get("products/all", {
                params: {
                    page,
                    limit: 10
                }
            ...
            resGetProducts = await _src_config_api__WEBPACK_IMPORTED_MODULE_4__["default"].get(`products/byCategory/${context.params.params}`, {
                params: {
                    page: page2,
                    limit: 10
                }
            ...
            resGetProducts = await _src_config_api__WEBPACK_IMPORTED_MODULE_4__["default"].get(`products/specifics/${splitParams3[0]}`, {
                params: {
                    page: page3,
                    limit: 10
                }
...
var __webpack_exports__ = __webpack_require__.X(0, [377,675,952,664,220,346], () => (__webpack_exec__(7975)));
