...
;// CONCATENATED MODULE: ./components/AdminPaymentDetails/index.js



function AdminPaymentDetails(props) {
    const { isOpen , onClose , key , paymentProof  } = props;
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.Modal, {
        isOpen: isOpen,
        onClose: onClose,
        children: [
...
/* harmony default export */ const components_AdminPaymentDetails = (AdminPaymentDetails);

;// CONCATENATED MODULE: ./components/AdminPaymentConfirm/index.js
...
function AdminPaymentConfirm(props) {
    const { key , trans_id , productName , totalPrice , status , paymentProof , productImage , courier , deliveryCost , createdAt , fetchTransactions , transaction_details ,  } = props;
    const toast = (0,react_.useToast)();
    const { isOpen , onOpen , onClose  } = (0,react_.useDisclosure)();
    const { 0: modalDetails , 1: setModalDetails  } = (0,external_react_.useState)(false);
    const rawStatus = status.split("_");
    const confirmPayment = async ()=>{
        try {
            const res = await api["default"].patch(`/transactions/adminPaymentConfirm/${trans_id}`);
            toast({
                description: res.data.message,
                position: "top",
                status: "success",
    ...
    const cancelPayment = async ()=>{
        try {
            const res = await api["default"].patch(`/transactions/adminCancelPayment/${trans_id}`);
            toast({
                description: res.data.message,
                position: "top",
                status: "success",
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(react_.VStack, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.Button, {
                            ...
                            children: [
                                "Payment Proof",
                                /*#__PURE__*/ jsx_runtime_.jsx(components_AdminPaymentDetails, {
                                    isOpen: isOpen,
                                    onClose: onClose,
                                    paymentProof: constraint.api_origin + paymentProof,
                                    props: props
                                }, trans_id)
                            ]
                        })
...
function Transaksi(props) {
    ...
    function mappedTransactionsPayment() {
        return filteredTransactions?.map((transaction)=>{
            return /*#__PURE__*/ jsx_runtime_.jsx(AdminPaymentConfirm, {
                productName: transaction.transaction_details[0].product.productName,
                productImage: transaction.transaction_details[0].product.productImage,
                transaction_details: transaction.transaction_details,
                            ...
                            children: [
                                ...
                                transac.length ? /*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.TabPanels, {
                                    children: [
                                        ...
                                        /*#__PURE__*/ jsx_runtime_.jsx(react_.TabPanel, {
                                            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                children: mappedTransactionsPayment()
                                            })
                                        })
                                    ]
                                }) : /*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.VStack, {
...
var __webpack_exports__ = __webpack_require__.X(0, [377,675,952,664,220,522], () => (__webpack_exec__(8653)));
