...
function Edit(props) {
    ...
    const validate = external_yup_.object({
        fullName: external_yup_.string().max(50, "Must be 50 characters or less").required("Required"),
...
var __webpack_exports__ = __webpack_require__.X(0, [377,675,952,664,220,346], () => (__webpack_exec__(1218)));
